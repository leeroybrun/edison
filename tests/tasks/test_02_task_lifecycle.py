...
def test_task_state_transitions(test_project_dir: TestProjectDir):
    ...
    blocked_path = test_project_dir.project_root / "tasks" / "blocked" / f"{task_id}.md"
    ...
    wip_path2 = test_project_dir.project_root / "tasks" / "wip" / f"{task_id}.md"
...
@pytest.mark.session
@pytest.mark.fast
def test_task_ownership(test_project_dir: TestProjectDir):
