...
def test_install_deps_uses_frozen_lockfile_for_pnpm(
    ...
    """When a pnpm lockfile is present, dependency install must not mutate it."""
    # Ensure pnpm is selected by presence of a pnpm lockfile, and that the files
    # exist in the branch we're branching from.
