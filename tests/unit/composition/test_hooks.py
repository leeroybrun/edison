...
def test_load_core_definitions(tmp_path: Path) -> None:
    ...
    write_yaml(tmp_path / ".edison/core/config/hooks.yaml", {"hooks": {"definitions": core_defs}})
...
def test_generate_settings_json_section(tmp_path: Path) -> None:
    ...
    write_yaml(tmp_path / ".edison/core/config/hooks.yaml", {"hooks": {"definitions": defs}})
...
def test_hook_types_validation(tmp_path: Path) -> None:
    ...
    write_yaml(tmp_path / ".edison/core/config/hooks.yaml", {"hooks": {"definitions": bad_defs}})
