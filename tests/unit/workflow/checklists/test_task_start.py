...
class TestChecklistItemModel:
    """Tests for the ChecklistItem dataclass model."""

    def test_checklist_item_has_required_fields(self) -> None:
        """ChecklistItem should have id, severity, title, rationale, status, evidencePaths, suggestedCommands."""
    ...
    def test_checklist_item_severity_values(self) -> None:
        """ChecklistItem severity should accept blocker, warning, info."""
        from edison.core.workflow.checklists.task_start import ChecklistItem
    ...
    def test_checklist_item_status_values(self) -> None:
        """ChecklistItem status should accept ok, missing, invalid, unknown."""
        from edison.core.workflow.checklists.task_start import ChecklistItem
    ...
    def test_checklist_item_to_dict(self) -> None:
        """ChecklistItem.to_dict() should serialize all fields."""
        from edison.core.workflow.checklists.task_start import ChecklistItem
...
class TestChecklistResult:
    """Tests for the ChecklistResult dataclass model."""

    def test_checklist_result_has_items_and_summary(self) -> None:
        """ChecklistResult should have items list and summary info."""
    ...
    def test_checklist_result_has_blockers(self) -> None:
        """ChecklistResult.has_blockers should return True if any blocker is missing/invalid."""
        from edison.core.workflow.checklists.task_start import ChecklistItem, ChecklistResult
        ...
        missing_item = ChecklistItem(id="missing", severity="blocker", title="x", rationale="x", status="missing")
    ...
    def test_checklist_result_to_dict(self) -> None:
        """ChecklistResult.to_dict() should serialize all fields."""
        from edison.core.workflow.checklists.task_start import ChecklistItem, ChecklistResult
...
class TestTaskStartChecklistEngine:
    """Tests for the TaskStartChecklistEngine."""

    def test_compute_returns_checklist_result(self, repo_env: Path) -> None:
        """TaskStartChecklistEngine.compute should return a ChecklistResult."""
        from edison.core.workflow.checklists.task_start import TaskStartChecklistEngine, ChecklistResult
    ...
    def test_tdd_reminder_item_present(self, repo_env: Path) -> None:
        """TaskStartChecklistEngine should include TDD reminder item."""
    ...
    def test_evidence_round_item_present(self, repo_env: Path) -> None:
        """TaskStartChecklistEngine should include evidence round initialization check."""
        from edison.core.workflow.checklists.task_start import TaskStartChecklistEngine
    ...
    def test_evidence_round_missing_is_blocker(self, repo_env: Path) -> None:
        """Evidence round missing should be a blocker."""
        from edison.core.workflow.checklists.task_start import TaskStartChecklistEngine
    ...
    def test_evidence_round_ok_when_initialized(self, repo_env: Path) -> None:
        """Evidence round should be OK when round directory exists."""
        from edison.core.workflow.checklists.task_start import TaskStartChecklistEngine
    ...
    def test_implementation_report_item_present(self, repo_env: Path) -> None:
        """TaskStartChecklistEngine should include implementation report check."""
        from edison.core.workflow.checklists.task_start import TaskStartChecklistEngine
    ...
    def test_context7_packages_item_when_required(self, repo_env: Path) -> None:
        """TaskStartChecklistEngine should include Context7 package checks when required."""
        from edison.core.workflow.checklists.task_start import TaskStartChecklistEngine

        # Create a task that triggers Context7 requirements
...
""",
        ...
        # Should have Context7 related item
        item_ids = [item.id for item in result.items]
    ...
    def test_context7_missing_packages_has_suggested_commands(self, repo_env: Path) -> None:
        """Missing Context7 packages should include suggested commands."""
        from edison.core.workflow.checklists.task_start import TaskStartChecklistEngine
...
""",
    ...
    def test_context7_invalid_markers_reported(self, repo_env: Path) -> None:
        """Invalid Context7 markers should be reported with missing fields."""
        from edison.core.workflow.checklists.task_start import TaskStartChecklistEngine
...
""",
        ...
        # Create evidence round with invalid marker (missing required fields)
        round_dir = repo_env / ".project" / "qa" / "validation-evidence" / task_id / "round-1"
        round_dir.mkdir(parents=True, exist_ok=True)
...
class TestChecklistEngineKinds:
    """Tests for supporting multiple checklist kinds."""

    def test_task_start_is_default_kind(self) -> None:
        """TaskStartChecklistEngine should produce 'task_start' kind."""
        from edison.core.workflow.checklists.task_start import TaskStartChecklistEngine
    ...
    def test_engine_supports_kind_parameter(self) -> None:
        """ChecklistResult kind should be settable for future extensibility."""
        from edison.core.workflow.checklists.task_start import ChecklistResult, ChecklistItem
...
class TestChecklistEngineIntegration:
    """Integration tests for checklist engine with real data."""

    def test_full_checklist_for_new_task(self, repo_env: Path) -> None:
        """A new task with no evidence should have multiple blockers."""
        from edison.core.workflow.checklists.task_start import TaskStartChecklistEngine
        ...
        # Should have at least evidence round blocker
        ev_item = next((i for i in result.items if i.id == "evidence-round"), None)
        assert ev_item is not None
        assert ev_item.status == "missing"
        assert ev_item.severity == "blocker"
    ...
    def test_full_checklist_serialization(self, repo_env: Path) -> None:
        """Checklist result should serialize to JSON-compatible dict."""
        from edison.core.workflow.checklists.task_start import TaskStartChecklistEngine
