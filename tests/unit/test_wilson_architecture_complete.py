...
Configuration (path, required sections, conclusion marker) lives entirely in
YAML to avoid hardcoded expectations in code.
"""
...
def _load_architecture_config() -> dict:
    ...
    cfg = read_yaml("config", CONFIG_FILE) or {}
