...
class RulesRegistryMigrationTests(unittest.TestCase):
    def setUp(self) -> None:
...
class RulesRegistryYamlConversionTests(unittest.TestCase):
    def setUp(self) -> None:
        self.env = os.environ.copy()
...
class RulesAnchorsAndContextCliTests(unittest.TestCase):
    def setUp(self) -> None:
        self.env = os.environ.copy()
