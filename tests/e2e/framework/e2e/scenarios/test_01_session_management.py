...
@pytest.mark.session
@pytest.mark.fast
def test_create_basic_session(test_project_dir: TestProjectDir):
...
@pytest.mark.fast
def test_create_worktree_session(test_project_dir: TestProjectDir):
...
@pytest.mark.task
@pytest.mark.fast
def test_session_task_tracking(test_project_dir: TestProjectDir):
...
@pytest.mark.session
@pytest.mark.fast
def test_session_status_command(test_project_dir: TestProjectDir):
...
@pytest.mark.session
@pytest.mark.fast
def test_multiple_sessions(test_project_dir: TestProjectDir):
...
@pytest.mark.qa
@pytest.mark.fast
def test_session_qa_tracking(test_project_dir: TestProjectDir):
