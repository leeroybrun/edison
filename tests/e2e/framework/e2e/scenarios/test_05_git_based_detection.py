...
@pytest.mark.fast
def test_detect_tsx_files_imply_react(test_project_dir: TestProjectDir):
    """Real: create .tsx file in session worktree and detect via git status."""
    session_id = "test-tsx-react"
    worktree_path = _create_session_with_worktree(test_project_dir.tmp_path, session_id)
...
@pytest.mark.requires_git
@pytest.mark.fast
def test_detect_prisma_files(test_project_dir: TestProjectDir):
...
@pytest.mark.requires_git
@pytest.mark.fast
def test_detect_zod_from_imports(test_project_dir: TestProjectDir):
...
@pytest.mark.requires_git
@pytest.mark.fast
def test_detect_react_from_jsx_syntax(test_project_dir: TestProjectDir):
...
@pytest.mark.requires_git
@pytest.mark.fast
def test_detect_multiple_packages_in_one_file(test_project_dir: TestProjectDir):
...
@pytest.mark.requires_git
@pytest.mark.fast
def test_detect_packages_from_directory_structure(test_project_dir: TestProjectDir):
...
@pytest.mark.requires_git
@pytest.mark.fast
def test_git_diff_multiple_commits(test_project_dir: TestProjectDir):
...
@pytest.mark.requires_git
@pytest.mark.fast
def test_detect_test_files_vs_source_files(test_project_dir: TestProjectDir):
...
@pytest.mark.requires_git
@pytest.mark.fast
def test_detect_config_files(test_project_dir: TestProjectDir):
...
@pytest.mark.requires_git
@pytest.mark.fast
def test_git_diff_empty_after_no_changes(test_project_dir: TestProjectDir):
...
@pytest.mark.requires_git
@pytest.mark.fast
def test_detect_deleted_files_in_diff(test_project_dir: TestProjectDir):
...
@pytest.mark.requires_git
@pytest.mark.fast
def test_detect_moved_files_in_diff(test_project_dir: TestProjectDir):
...
@pytest.mark.requires_git
@pytest.mark.fast
def test_detect_prisma_schema_in_packages_db(test_project_dir: TestProjectDir):
...
@pytest.mark.requires_git
@pytest.mark.fast
def test_detect_prisma_migrations(test_project_dir: TestProjectDir):
...
@pytest.mark.requires_git
@pytest.mark.fast
def test_detect_prisma_seed_files(test_project_dir: TestProjectDir):
