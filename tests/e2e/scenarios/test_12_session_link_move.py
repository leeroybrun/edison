...
def test_link_moves_tasks_into_session(project_dir: TestProjectDir):
    ...
    parent_path = project_dir.project_root / "sessions" / "wip" / session_id / "tasks" / "todo" / f"{parent_id}.md"
    child_path = project_dir.project_root / "sessions" / "wip" / session_id / "tasks" / "todo" / f"{child_id}.md"
