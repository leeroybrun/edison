...
class TestTaskCreationRealCLI:
    ...
    def test_create_task_via_cli_success(self, project_dir: TestProjectDir):
    ...
    def test_create_task_duplicate_id_fails(self, project_dir: TestProjectDir):
...
class TestTaskStatusRealCLI:
    ...
    def test_claim_task_via_cli(self, project_dir: TestProjectDir):
    ...
    def test_move_task_to_wip(self, project_dir: TestProjectDir):
        ...
        todo_dir = project_dir.project_root / "tasks" / "todo"
...
class TestSessionNextRealCLI:
    ...
    def test_session_next_returns_json(self, project_dir: TestProjectDir):
    ...
    def test_session_next_no_tasks_available(self, project_dir: TestProjectDir):
...
class TestGuardEnforcement:
    ...
    def test_tasks_ready_blocks_incomplete_task(self, project_dir: TestProjectDir):
    ...
    def test_tasks_ready_allows_complete_task(self, project_dir: TestProjectDir):
...
class TestAntiPatterns:
    ...
    def test_wrong_no_output_validation(self, project_dir: TestProjectDir):
        ...
        task_path = project_dir.get_task_path(task_id)
