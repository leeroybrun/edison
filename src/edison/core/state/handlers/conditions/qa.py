...
def has_bundle_approval(ctx: Mapping[str, Any]) -> bool:
    ...
    from edison.core.state.handlers.guards.qa import has_bundle_approval as guard_check
...
def has_all_waves_passed(ctx: Mapping[str, Any]) -> bool:
    ...
    """
    # Delegate to guard implementation
    from edison.core.state.handlers.guards.qa import has_all_waves_passed as guard_check
    return guard_check(ctx)
