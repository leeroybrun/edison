"""Session worktree manager public surface.

This package provides the stable import location:
...
from .create import create_worktree, ensure_worktree_materialized, resolve_worktree_target, restore_worktree
