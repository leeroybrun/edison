...
This module provides a thin integration layer between the Edison
...
def _detect_repo_root(explicit_root: Optional[Path] = None) -> Path:
    ...
    canonical PathResolver so ZenAdapter shares consistent semantics
...
@dataclass
class ZenAdapter:
    """Adapter between Edison composition and Zen MCP prompts."""
