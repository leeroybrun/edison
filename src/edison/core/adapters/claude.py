...
This adapter is intentionally thin:
  ...
  - Delegates rich agent conversion to `ClaudeCodeAdapter` where
...
from ..claude_adapter import ClaudeCodeAdapter  # type: ignore
...
class ClaudeAdapter(PromptAdapter):
    ...
    def write_outputs(self, output_root: Path) -> None:
        ...
        # Existing: Agents
        adapter = ClaudeCodeAdapter(repo_root=self.repo_root)
