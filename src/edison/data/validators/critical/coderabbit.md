...
**Blocks on Fail**: ✅ YES (critical/security issues prevent completion)
...
- 🔍 **Comprehensive**: Parse ALL findings
- 🎯 **Precise**: Map to exact severity levels
- 📊 **Structured**: Transform into consistent reports
- 🔗 **Contextual**: Cross-reference with project standards
- ⚖️ **Fair**: Severity based on real impact
...
**Task**: [Task ID]
**Status**: ✅ APPROVED | ⚠️ WARNINGS | ❌ REJECTED
**Timestamp**: [ISO 8601]
