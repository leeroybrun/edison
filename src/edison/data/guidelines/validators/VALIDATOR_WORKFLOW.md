...
7. **Report** – Write the validator report JSON (see OUTPUT_FORMAT) and update the QA brief with findings, evidence links, and verdict. Include the model you used.
