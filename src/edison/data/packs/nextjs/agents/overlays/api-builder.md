...
- If your stack uses an ORM + schema validation, follow the active pack patterns (e.g., Prisma + Zod) without duplicating logic.
...
- Reference: `packs/nextjs/guidelines/nextjs/route-handlers.md`
<!-- /extend -->
