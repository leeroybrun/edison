---
id: task-backlog-coherence
domain: task
command: backlog-coherence
short_desc: Deep read-only backlog coherence review (tasks + waves)
cli: 'edison task audit --json --tasks-root .project/tasks

  edison task waves --json

  '
args: []
when_to_use: '- You are about to start a major implementation cycle and want to reduce
  competing work
