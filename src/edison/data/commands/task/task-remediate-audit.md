---
id: task-remediate-audit
domain: task
command: remediate-audit
short_desc: Approval-gated remediation from deterministic audit
...
- name: --tasks-root
  ...
  required: false
- name: --dry-run
  description: Show proposed edits without applying them.
  required: false
when_to_use: '- You want to convert audit findings into concrete task edits
